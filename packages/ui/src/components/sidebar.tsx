...
import { useIsMobile } from '@edgarguzman/lib/hooks/use-mobile';
...
import { Button } from '@edgarguzman/ui/components/button';
import { Input } from '@edgarguzman/ui/components/input';
import { Separator } from '@edgarguzman/ui/components/separator';
import {
    Sheet,
    SheetContent,
    SheetDescription,
    SheetHeader,
    SheetTitle,
} from '@edgarguzman/ui/components/sheet';
import { Skeleton } from '@edgarguzman/ui/components/skeleton';
import {
    Tooltip,
    TooltipContent,
    TooltipProvider,
    TooltipTrigger,
} from '@edgarguzman/ui/components/tooltip';
...
>(
    (
        ...
        let contextValue = React.useMemo<SidebarContextProps>(() => {
            return {
                state,
                open,
                setOpen,
